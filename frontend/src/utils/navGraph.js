 ...
 *
 * IMPORTANT: All indoor node (x,y) coordinates MUST match the exact visual
 * center of each room as defined in the ARCH_PLANS floor data in CampusMap.jsx.
 *
 * Campus-level node (x,y) coordinates must match the FLAT building positions:
 *   block_a:105,85  block_b:210,85  block_c:315,85  block_d:415,85
 *   block_e:510,85  block_f:510,180  block_g:510,275  block_h:510,370
 *   block_ij:410,375  block_k:310,375  block_l:205,375  tifac:100,375
 */

export const NAV_GRAPHS = {
    campus: {
        nodes: [
            // Courtyard loop corners (match FPATHS exactly)
            ...
            { id: 'CP-AMP-N', x: 300, y: 180, type: 'path', label: 'Amp-North' },
            { id: 'CP-AMP-S', x: 300, y: 280, type: 'path', label: 'Amp-South' },
            { id: 'CP-AMP-E', x: 370, y: 230, type: 'path', label: 'Amp-East' },
            // Building entry gates (on or near the loop wall)
            { id: 'ENT-block_a', x: 110, y: 140, type: 'entry', label: 'Block A Gate', buildingId: 'block_a' },
            { id: 'ENT-block_b', x: 210, y: 140, type: 'entry', label: 'Block B Gate', buildingId: 'block_b' },
            { id: 'ENT-block_c', x: 315, y: 140, type: 'entry', label: 'Block C Gate', buildingId: 'block_c' },
            { id: 'ENT-block_d', x: 415, y: 140, type: 'entry', label: 'Block D Gate', buildingId: 'block_d' },
            { id: 'ENT-block_e', x: 450, y: 85, type: 'entry', label: 'Block E Gate', buildingId: 'block_e' },
            { id: 'ENT-block_f', x: 450, y: 180, type: 'entry', label: 'Block F Gate', buildingId: 'block_f' },
            { id: 'ENT-block_g', x: 450, y: 275, type: 'entry', label: 'Block G Gate', buildingId: 'block_g' },
            { id: 'ENT-block_h', x: 450, y: 320, type: 'entry', label: 'Block H Gate', buildingId: 'block_h' },
            { id: 'ENT-block_ij', x: 410, y: 320, type: 'entry', label: 'Block I/J Gate', buildingId: 'block_ij' },
            { id: 'ENT-block_k', x: 310, y: 320, type: 'entry', label: 'Block K Gate', buildingId: 'block_k' },
            { id: 'ENT-block_l', x: 205, y: 320, type: 'entry', label: 'Block L Gate', buildingId: 'block_l' },
            { id: 'ENT-tifac', x: 110, y: 320, type: 'entry', label: 'TIFAC Gate', buildingId: 'tifac' },
            { id: 'ENT-center', x: 300, y: 230, type: 'entry', label: 'Amphitheater', buildingId: 'center_stage' },
        ],
        edges: [
            // North corridor
            { from: 'CP-NW', to: 'ENT-block_b', weight: 100 },
            { from: 'ENT-block_a', to: 'CP-NW', weight: 1 },
    ...
    // ── Block C (CS) ─────────────────────────────────────────────────
    // Floor plan viewBoxes: GF "0 0 460 310", 1F "0 0 460 310", 2F "0 0 460 310"
    // Room centers computed as x+w/2, y+h/2 from ARCH_PLANS
    block_c: {
        nodes: [
            // Ground Floor (floor index 0)
            { id: 'CS-G-ENT', x: 440, y: 205, floor: 0, type: 'entry', label: 'Main Entrance' },
            { id: 'CS-G-CORR', x: 230, y: 160, floor: 0, type: 'corridor', label: 'Ground Corridor' },
            ...
            // First Floor (floor index 1)
            { id: 'CS-1-CORR', x: 230, y: 160, floor: 1, type: 'corridor', label: '1F Corridor' },
            ...
            { id: 'CS-1-STAIRS', x: 386, y: 249, floor: 1, type: 'stairs', label: '1F Stairs' },
            // Second Floor (floor index 2)
            { id: 'CS-2-CORR', x: 230, y: 113, floor: 2, type: 'corridor', label: '2F Corridor' },
            ...
            { id: 'CS-2-STAIRS', x: 398, y: 250, floor: 2, type: 'stairs', label: '2F Stairs' },
        ],
        edges: [
            // Ground floor
            { from: 'CS-G-ENT', to: 'CS-106', weight: 60 },
            { from: 'CS-G-CORR', to: 'CS-101', weight: 106 },
            { from: 'CS-G-CORR', to: 'CS-102', weight: 106 },
            { from: 'CS-G-CORR', to: 'CS-103', weight: 71 },
            { from: 'CS-G-CORR', to: 'CS-104', weight: 71 },
            { from: 'CS-G-CORR', to: 'CS-105', weight: 90 },
            { from: 'CS-G-CORR', to: 'CS-106', weight: 174 },
            { from: 'CS-106', to: 'CS-G-STAIRS', weight: 61 },
            // 1st floor
            { from: 'CS-1-CORR', to: 'CS-201', weight: 106 },
            { from: 'CS-1-CORR', to: 'CS-202', weight: 150 },
            { from: 'CS-1-CORR', to: 'CS-203', weight: 162 },
            { from: 'CS-1-CORR', to: 'CS-204', weight: 71 },
            { from: 'CS-1-CORR', to: 'CS-205', weight: 44 },
            { from: 'CS-1-CORR', to: 'CS-1-STAIRS', weight: 156 },
            // 2nd floor
            { from: 'CS-2-CORR', to: 'CS-301', weight: 1 },
            { from: 'CS-2-CORR', to: 'CS-302', weight: 137 },
            { from: 'CS-2-CORR', to: 'CS-303', weight: 56 },
            { from: 'CS-2-CORR', to: 'CS-2-STAIRS', weight: 168 },
            // Inter-floor stairs
    ...
    // ── Block A (Admin) ──────────────────────────────────────────────
    // Floor plan viewBox: "0 0 500 380", outer: x:20,y:20,w:460,h:340
    // Corridor band: y:188-212 (center y=200)
    // Room centers: MN-101:96,104  MN-102:252,104  MN-103:406,104
    //               MN-104:88,286  MN-105:230,286  MN-106:362,247
    //               MN-107:362,323 (stairs)         MN-108:452,286
    block_a: {
        nodes: [
            { id: 'MN-G-ENT', x: 252, y: 360, floor: 0, type: 'entry', label: 'Front Entrance' },
            { id: 'MN-G-CORR', x: 252, y: 200, floor: 0, type: 'corridor', label: 'Main Corridor' },
        ...
        edges: [
            { from: 'MN-G-ENT', to: 'MN-G-CORR', weight: 160 },
            { from: 'MN-G-CORR', to: 'MN-101', weight: 156 },
            { from: 'MN-G-CORR', to: 'MN-102', weight: 4 },
            { from: 'MN-G-CORR', to: 'MN-103', weight: 154 },
            { from: 'MN-G-CORR', to: 'MN-104', weight: 86 },
            { from: 'MN-G-CORR', to: 'MN-105', weight: 86 },
            { from: 'MN-G-CORR', to: 'MN-106', weight: 110 },
            { from: 'MN-106', to: 'MN-107', weight: 76 },
        ]
    },

    // Simplified graphs for other buildings (entry node only)
